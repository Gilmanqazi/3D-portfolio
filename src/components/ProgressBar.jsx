...
useEffect(()=>{
  ...
  //Create a GSAP animaton that update the width of the progress bar based on the scroll position
...
scrollTrigger:{
  ...
  onUpdate:(self)=>{
    ...
    if(progress>0.75){
      gsap.to(progressFillRef.current,{backgroundColor:"#FA003F",duration:0.5})
